...
$title = "My Blog\'s Story of Becoming What It Is";
$author = 'Mike';
$date = '09.03.2025';
$content = '<p> The idea to host my own blog came from a project I did for the Udemy
...
$insertSql = $db->prepare('INSERT INTO post(ptitle, pauthor, pdate, pcontent) VALUES(
                :title,
                :author,
                :date,
                :content
...
$insertSql->bindValue(':author', $author);
$insertSql->bindValue(':date', $date);
